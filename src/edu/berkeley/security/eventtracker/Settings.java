...
public class Settings extends EventActivity {
	...
	private NumberPicker2 GPSSensitivity;
	private NumberPicker2 GPSUpdateTime;
	private OnSharedPreferenceChangeListener listener;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
	    GPSUpdateTime=(NumberPicker2) findViewById(R.id.Picker1);
	    GPSSensitivity = (NumberPicker2) findViewById(R.id.Picker2);
